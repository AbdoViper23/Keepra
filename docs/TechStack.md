...
### Decentralized (MPC Committee) Key Server — Testnet _(recommended primary)_
...
### Seal package (testnet) — _already deployed by Mysten_
...
| Sui Foundation blog                   | https://blog.sui.io/                                            |
